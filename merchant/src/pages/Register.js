...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      validation &&
      formData.phoneNumber.replace(/\D/g, "").length !== validation.length
    ) {
      toast.error(
    ...
    try {
      ...
      toast.success(
        `Account created! Verification code sent to ${formData.email}`
      );
      setShowOtpStep(true);
    } catch (error) {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Create your merchant account and start reaching thousands of
            customers. Manage your products, track sales, and grow your business
            with ease.
          </p>
        </div>
      </div>
          ...
          >
            ...
            >
              {showOtpStep
                ...
                : "Start selling on Paya Marketplace"}
            </p>
          </div>
                      ...
                      onChange={(e) => {
                        ...
                        const maxLength =
                          formData.phoneCountryCode === "+1"
                            ? 10
                            : formData.phoneCountryCode === "+27"
                            ? 9
                            : formData.phoneCountryCode === "+255"
                            ? 9
                            : 9; // Kenya default
                ...
                style={{
                  ...
                  cursor:
                    verifyingOtp || otp.length !== 6
                      ? "not-allowed"
                      : "pointer",
                  opacity: verifyingOtp || otp.length !== 6 ? 0.7 : 1,
                  transition: "opacity 0.2s",
                }}
              >
