...
const Marketplace = () => {
  ...
  const priceRanges = [
    ...
    {
      label: "KES 5,000 - KES 15,000",
      min: 5000,
      max: 15000,
      value: "5000-15000",
    },
    {
      label: "KES 15,000 - KES 50,000",
      min: 15000,
      max: 50000,
      value: "15000-50000",
    },
    {
      label: "KES 50,000 - KES 100,000",
      min: 50000,
      max: 100000,
      value: "50000-100000",
    },
    {
      label: "KES 100,000 - KES 200,000",
      min: 100000,
      max: 200000,
      value: "100000-200000",
    },
    {
      label: "Over KES 200,000",
      min: 200000,
      max: Infinity,
      value: "200000-inf",
    },
                ...
                label={
                  <Typography
                    ...
                    sx={{
                      color: "#475569",
                      fontWeight:
                        selectedPriceRange === range.value ? 600 : 400,
                    }}
                  >
                    {range.label}
                  </Typography>
